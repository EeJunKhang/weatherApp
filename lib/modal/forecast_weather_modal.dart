...
class ForecastWeatherModal {
  ...
  factory ForecastWeatherModal.fromRawJson(String str) =>
      ForecastWeatherModal.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ForecastWeatherModal.fromJson(Map<String, dynamic> json) =>
      ForecastWeatherModal(
...
final textValues = EnumValues({
  ...
  "Light drizzle": Description.LIGHT_DRIZZLE,
  "Light rain": Description.LIGHT_RAIN,
  "Moderate rain": Description.MODERATE_RAIN,
  "Overcast": Description.OVERCAST,
  "Partly cloudy": Description.PARTLY_CLOUDY,
  "Patchy rain possible": Description.PATCHY_RAIN_POSSIBLE,
  "Sunny": Description.SUNNY
});

enum WindDir { SSW, SW, W, WNW, WSW }
